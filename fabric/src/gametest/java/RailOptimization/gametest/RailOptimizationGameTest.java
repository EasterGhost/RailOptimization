...
public class RailOptimizationGameTest extends RailOptimizationGameTestSupport {
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_01", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_02", maxTicks = 140)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_03", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_04", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_05", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_06", maxTicks = 180)
    ...
    @SuppressWarnings("null")
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_07", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_08", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_09", maxTicks = 100)
