...
public class RailOptimizationSlopeGameTest extends RailOptimizationGameTestSupport {
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_10", maxTicks = 140)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_11", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_12", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_13", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_14", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_15", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_16", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_17", maxTicks = 100)
