...
public class RailOptimizationNeighborUpdateGameTest extends RailOptimizationGameTestSupport {
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_18", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_19", maxTicks = 100)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_21", maxTicks = 140)
    ...
    @GameTest(structure = "railoptimization-gametest:compat_empty", environment = "railoptimization-gametest:serial_22", maxTicks = 140)
