...
public class RailOptimizationPerformanceGameTest extends RailOptimizationGameTestSupport {
    ...
    private static final int STATE_CHANGE_WARMUP_OPERATIONS = 400;
    private static final int UNCHANGED_UPDATE_WARMUP_OPERATIONS = 50_000;
    private static final int INDIRECT_UPDATE_WARMUP_OPERATIONS = 20_000;
    private static final int STATE_CHANGE_STABILIZATION_OPERATIONS = 100;
    private static final int UNCHANGED_UPDATE_STABILIZATION_OPERATIONS = 10_000;
    private static final int INDIRECT_UPDATE_STABILIZATION_OPERATIONS = 5_000;
    private static final int MEASUREMENT_ROUNDS = 11;
    private static final int TOGGLES_PER_ROUND = 400;
    private static final int UNCHANGED_UPDATES_PER_ROUND = 100_000;
    private static final int INDIRECT_UPDATES_PER_ROUND = 20_000;
